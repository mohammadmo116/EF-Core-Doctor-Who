        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstEpisodDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastEpisodDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EpisodNumber = table.Column<int>(type: "int", nullable: true),
                    EpisodType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EpisodDate = table.Column<DateTime>(type: "datetime2", nullable: true),
